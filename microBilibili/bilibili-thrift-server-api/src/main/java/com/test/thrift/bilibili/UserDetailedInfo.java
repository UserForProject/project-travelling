    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserDetailedInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.videos != null) {
        oprot.writeFieldBegin(VIDEOS_FIELD_DESC);
        {
          ...
          for (java.util.Map<java.lang.String,java.lang.String> _iter10 : struct.videos)
          {
            {
              oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, _iter10.size()));
              for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter11 : _iter10.entrySet())
              {
      ...
      if (struct.fansData != null) {
        oprot.writeFieldBegin(FANS_DATA_FIELD_DESC);
        {
          ...
          for (int _iter12 : struct.fansData)
          {
      ...
      if (struct.isSetVideos()) {
        {
          ...
          for (java.util.Map<java.lang.String,java.lang.String> _iter13 : struct.videos)
          {
            {
              oprot.writeI32(_iter13.size());
              for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter14 : _iter13.entrySet())
              {
      ...
      if (struct.isSetFansData()) {
        {
          ...
          for (int _iter15 : struct.fansData)
          {
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.videos = new java.util.ArrayList<java.util.Map<java.lang.String,java.lang.String>>(_list16.size);
          @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> _elem17;
          ...
          {
            {
              ...
              _elem17 = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map19.size);
      ...
      if (incoming.get(10)) {
        {
          ...
          struct.fansData = new java.util.ArrayList<java.lang.Integer>(_list23.size);
          int _elem24;
          for (int _i25 = 0; _i25 < _list23.size; ++_i25)
          {
            _elem24 = iprot.readI32();
            struct.fansData.add(_elem24);
          }
        }
        struct.setFansDataIsSet(true);
      }
